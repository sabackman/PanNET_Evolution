...
#
# 
# df_all <- data.frame(Sample=c(samples1, samples2, samples3, samples4), 
#                      Gene=c(genes1, genes2, genes3, genes4), 
#                      Mutation=c(mut1, mut2, mut3, mut4), 
#                      Patient=c(rep("PanNET1", 54), rep("PanNET2", 27), rep("PanNET3", 81), rep("PanNET4", 81)))
# p2 <- ggplot(df_all, aes(x=factor(Sample, levels=c("P1a", "P1b", "P1c", "M1", "M1a", "M1b", "M1c", "M2", "M2a", "M2b", "M3", "M3a", "M3b", "M4a", "M4b")), y=factor(Gene,levels=c("MEN1", "ATRX", "DAXX", "PTEN", "DEPDC5", "SETD2", "TSC2", "TP53", "ARID1A")), fill=Mutation)) + 
...
# 
# 
# Patients <- c(rep("PanNET_4",9),rep("PanNET_3",9),rep("PanNET_2",3),rep("PanNET_1",6))
# sample_name <- c("M1a","M1b","P1b","P1c","M1c","M3","P1a","M2b","M2a",
#                  "M4b","P1a","P1b","M2","M4a","M3a","M1","M3b","P1c",
#                  "P1b","P1a","M1",
#                  "M2","P1c","M1b","P1a","M1a","P1b")
# mut_burden <- c(0.95,0.96,0.83,1.02,1.04,1.14,0.98,1.16,1.21,181.61,1.43,1.71,277.08,234.88,226.60,238.59,219.98,2.40,1.18,1.15,1.19,2.77,1.57,2.10,1.29,2.47,1.36)
# 
...
# 
# 
# plot_grid(p1, p2, p5, p3, nrow=4, align="v", axis="lr", rel_heights = c(1,2,0.3,0.4))
# 
...
sample_name <- c("M1a","M1b","P1b","P1c","M1c","M3","P1a","M2b","M2a",
                 "M4b","P1a","P1b","M2","M4a","M3a","M1","M3b","P1c",
                 "P1b","P1a","M1",
                 "M2","P1c","M1b","P1a","M1a","P1b","M1a", "M1b", "M2","M1", "M2")
mut_burden <- c(0.95,0.96,0.83,1.02,1.04,1.14,0.98,1.16,1.21,181.61,1.43,1.71,277.08,234.88,226.60,238.59,219.98,2.40,1.18,1.15,1.19,2.77,1.57,2.10,1.29,2.47,1.36, 1.54, 1.45, 5.49, 0.72, 4.73)
